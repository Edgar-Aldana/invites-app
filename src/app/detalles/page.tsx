...
import Carousel  from "../components/carouselImages/carouselImages";
...
export default function Details() {
    ...
    {
      title: "jardin-dron",
      src: "https://lh3.googleusercontent.com/p/AF1QipOIOzurgKEqmYCaWY3-1HqaHAiJrYTmMvD2qepp=s1360-w1360-h1020-rw",
    },
    {
      title: "jardin",
      src: "https://lh3.googleusercontent.com/p/AF1QipPHYMuFu6N7SCnWOybm3YXndIFyiv3KxA5hjudj=s1360-w1360-h1020-rw",
    },
    {
      title: "Neon Nights",
      src: "https://lh3.googleusercontent.com/p/AF1QipPxAmiU58DZ5hsAY-x5_XEQ3byb7cA7PjO3B0O9=s1360-w1360-h1020-rw",
    },
    {
      title: "Desert Whispers",
      src: "https://lh3.googleusercontent.com/gps-cs-s/AC9h4nqNSsmuqSXouN-i-jk0ikR5NOd-cLYIdwemiSU0TFHC4OztuMOlLo1YALNsY4SAM-ED6dlRbunsPGx4jLv1G0FVXCEMY5S20yiI1AKURjT0GVC6fERjQSf-J2IYg9quwOBmPf1Q1I6y_YA3=s1360-w1360-h1020-rw",
    },
  ];
    ...
    return (
        ...
        <>
            ...
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="w-full min-h-screen bg-transparent flex flex-col items-center px-4 py-20"
            >
                <BackgroundDetails />
                ...
                <div className="w-full max-w-7xl flex flex-col items-center rounded-2xl text-center mb-10 p-4 backdrop-blur-md bg-black/35 border border-white/30 shadow-xl">
                    ...
                    <div className="grid grid-cols-1 gap-x-6 gap-y-6 w-full max-w-5xl place-items-center mb-10">


                        <div className="w-full sm:w-[65%] flex items-center justify-center p-4 border-2 border-dashed border-[#bbdb93] rounded-xl bg-black/25">
                        ...
                        <div className="flex flex-col items-center text-center w-full sm:w-[95%]">
    

                            <div className="relative overflow-hidden flex flex-col gap-2 w-full h-full pb-20">
                                <span className="font-['forumFont'] text-xl sm:text-2xl text-white">Jardín Antigua Fábrica de Hielo <br /> "El molino"</span>
                            ...
                            <a
                                ...
                                className="w-[60%] sm:w-[30%] flex items-center justify-center font-['forumFont'] bg-yellow-400 text-lg sm:text-2xl mt-4 rounded-md p-2 border-2 border-dashed border-red-400 hover:bg-yellow-300 transition"
                            >
                            ...
                            <div className="flex flex-col w-[90%] sm:w-[40%] font-['forumFont'] text-xl text-white mt-5 rounded-md px-4 py-10 border border-white bg-white/25">
                    ...
                    {showRespondButton || showChangeMindButton ? (
                        <motion.div
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="flex w-[80%] sm:w-[65%] md:w-[70%] lg:w-[25%] justify-center items-center gap-2 h-14 
